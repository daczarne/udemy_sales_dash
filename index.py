			...
			[
				html.Div(
					[
						dt.DataTable(
							id = "my_datatable",
							columns = [{"name": i, "id": i} for i in sales.loc[:, ["Order Date", "Customer ID", "Customer Name", "Segment", "City", "State", "Region", "Category","Sub-Category", "Product Name", "Sales", "Year", "Month"]]],
							virtualization = True,
							style_cell = {
								"textAlign": "left",
								"min-width": "100px",
...
def update_graph(select_years, radio_items, radio_items1):
	...
	sales2 = sales1[
		(sales1["Year"] == select_years) &
		(sales1["Segment"] == radio_items)
	...
	sales4 = sales3[
		(sales3["Year"] == select_years) &
		(sales3["Segment"] == radio_items)
	...
	if radio_items1 == "Sub-Category":
      ...
      "layout": go.Layout(
				title = {
					"text": "Sales by Sub-Category" + " " + str(select_years),
					"y": 0.99,
					"x": 0.5,
					"xanchor": "center",
					"yanchor": "top"
		...
		fig = {
			...
			"layout": go.Layout(
				title = {
					"text": "Sales by Region in year" + " " + str(select_years),
					"y": 0.99,
					"x": 0.5,
					"xanchor": "center",
					"yanchor": "top"
...
def update_graph(select_years, radio_items):
	...
	# Build slices
	sales_furniture = sales5[
		(sales5["Year"] == select_years) &
		(sales5["Segment"] == radio_items) &
		(sales5["Category"] == "Furniture")
	]["Sales"].sum()
	sales_Office = sales5[
		(sales5["Year"] == select_years) &
		(sales5["Segment"] == radio_items) &
		(sales5["Category"] == "Office Supplies")
	]["Sales"].sum()
	sales_Technology = sales5[
		(sales5["Year"] == select_years) &
		(sales5["Segment"] == radio_items) &
		(sales5["Category"] == "Technology")
	]["Sales"].sum()
	# List of colors
	...
	fig = {
		...
		"layout": go.Layout(
			title = {
				"text": "Sales by Category in year" + " " + str(select_years),
				"y": 0.93,
				"x": 0.5,
				"xanchor": "center",
				"yanchor": "top"
...
def update_graph(select_years, radio_items):
	...
	fig = {
		"data": [
			...
			"layout": go.Layout(
				title = {
					"text": "Sales Trend in Year" + " " + str(select_years),
					"y": 0.99,
					"x": 0.5,
					"xanchor": "center",
					"yanchor": "top"
...
def update_graph(select_years, radio_items, radio_items2):
	...
	sales13 = sales12[
		(sales12["Year"] == select_years) &
		(sales12["Segment"] == radio_items)
	].sort_values(by = ["Sales"], ascending = False).nlargest(10, columns = ["Sales"])
	sales14 = sales.groupby(["Year", "City", "Segment"])["Sales"].sum().reset_index()
	sales15 = sales14[
		(sales14["Year"] == select_years) &
		(sales14["Segment"] == radio_items)
	].sort_values(by = ["Sales"], ascending = False).nlargest(10, columns = ["Sales"])
	# Build fig
	if radio_items2 == 'State':
		fig = {
			...
			"layout": go.Layout(
				title = {
					"text": "Sales by State in year " + str(select_years),
					"y": 0.99,
					"x": 0.5,
					"xanchor": "center",
					"yanchor": "top"
		...
		fig = {
			...
			"layout": go.Layout(
				title={
					"text": "Sales by City in year " + str(select_years),
					"y": 0.99,
					"x": 0.5,
					"xanchor": "center",
					"yanchor": "top"
...
def update_graph(select_years, radio_items):
	...
	fig = {
		...
		"layout": go.Layout(
			title = {
				"text": "Sales by state and city in Year " + str(select_years),
				"y": 0.99,
				"x": 0.5,
				"xanchor": "center",
				"yanchor": "top"
